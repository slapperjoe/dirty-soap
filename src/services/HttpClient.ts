...
export class HttpClient {
     ...
     */
    async execute(request: SoapUIRequest, options?: HttpClientOptions): Promise<HttpResponse> {
     ...
     */
    async executeRest(request: SoapUIRequest, options?: HttpClientOptions): Promise<HttpResponse> {
        ...
        if (request.restConfig?.pathParams) {
            for (const [key, value] of Object.entries(request.restConfig.pathParams)) {
     ...
     */
    async executeGraphQL(request: SoapUIRequest, options?: HttpClientOptions): Promise<HttpResponse> {
     ...
     */
    async executeSoap(request: SoapUIRequest, options?: HttpClientOptions): Promise<HttpResponse> {
        const endpoint = request.endpoint || '';
        const headers: Record<string, string> = {
     ...
     */
    private getProxySettings(): { proxyUrl: string | undefined; strictSSL: boolean } {
     ...
     */
    private applyAuth(headers: Record<string, string>, restConfig?: RestConfig): void {
